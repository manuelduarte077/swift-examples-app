...
Action(name: "Conocer más sobre nosotros", action: "seguir", icon: "hand.thumbsup", url: "donmanuel.dev"),
Action(name: "Desarrollador", action: "developer", icon: "person", url: "https://github.com/manuelduarte077")
]
